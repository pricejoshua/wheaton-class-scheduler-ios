...
//// To parse the JSON, add this file to your project and do:
////
////   let courses = try? newJSONDecoder().decode(Courses.self, from: jsonData)
//
//import Foundation
//
//// MARK: - Welcome
...
//        case subject
//        case classID = "classId"
//        case crn, seatsCapacity, seatsRemaining, waitCapacity, waitRemaining, lastUpdateTime, classType, campus, url, profs, meetings
//    }
//}
//
//enum ClassType: String, Codable {
